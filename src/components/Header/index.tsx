...
export function Header() {
  return (
    <header className="bg-zinc-800 py-2 px-20">
      ...
      <div className="flex justify-center">
        <small className="flex text-white italic justify-center flex-wrap">
          hero list using&nbsp;
          <a
            className="text-red-500 transition-colors duration-300 hover:text-gray-500"
          ...
          &nbsp;developed by&nbsp;
          <a
            className="flex justify-center items-center transition-colors duration-300 hover:text-gray-500"
            href="http://github.com/JrzenonDev"
            target="_blank"
          >
            José Roberto&nbsp;
            <span className="text-base ml-1 mb-1 text-red-500">
              <FaGithub />
            </span>
          </a>
        </small>
